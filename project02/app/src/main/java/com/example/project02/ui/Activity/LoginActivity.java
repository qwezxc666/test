...
import com.example.project02.Bean.LgoinResultBean;
import com.example.project02.Bean.LoginBody;
...
public class LoginActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void submit() {
        ...
        Okhttp.post("/prod-api/api/login", new LoginBody(et1String, et2String), new MyCallback(getthis(), LgoinResultBean.class) {
            @Override
            public void onFish(Object o) {
                LgoinResultBean resultBean= (LgoinResultBean) o;
                if (resultBean.code==200){
                    SharedPreferences.Editor sp=getSharedPreferences("app",MODE_PRIVATE).edit();
                    sp.putString("token",resultBean.token);
                    sp.apply();
