...
import com.example.project07.Bean.passBody;
import com.example.project07.MyCallback;
import com.example.project07.Okhttp;
import com.example.project07.R;
import com.example.project07.Tool;

public class EditPasswActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_passw);
        initView();
        setTitle("修改密码");
    }
    ...
    private void submit() {
        ...
        Okhttp.postheand(" /prod-api/api/common/user/resetPwd", Tool.gettoken(getthis()),new passBody(et1String,et2String), new MyCallback(getthis(), ResultBean.class) {
            @Override
